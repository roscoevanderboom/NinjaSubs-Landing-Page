            ...
            <Card plain>
                ...
                <CardBody>
                    <p className={classes.description}>
                        Based in South Africa, I develop web apps with <ReactAnchor />, <FirebaseAnchor />
                        and <MaterialUIAnchor />. I also develop desktop apps using <ElectronAnchor />,
                        <ReactAnchor /> and <MultichainAnchor />. I am very passionate about decentralized
                        technologies such as blockchain, <IPFSAnchor /> and <DATAnchor />. My dream is to be a
                        digital nomad and educate people in remote coommunities about the internet and the joys
                        of coding.
                    </p>
                </CardBody>
